...
int main(int argc, char *argv[])
{
        ...
        //inet_pton(AF_INET6, "5200::250:56ff:fe9f:45f", &server_addr.sin6_addr);
        inet_pton(AF_INET6, "fe80::250:56ff:fe9f:45f", &server_addr.sin6_addr);
        server_addr.sin6_port = htons(SERVER_PORT);
        server_addr.sin6_scope_id = if_nametoindex("ens192");
